...
(function () {
  ...
  var SCINTILLA = '<svg viewBox="0 0 24 34" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M15 1 L7 14 L13 15 L6 33" fill="none" stroke="#eaf4ff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>';
  ...
  function schermataHome() {
    ...
    s._contenuto.appendChild(el("div", { class: "home-hero" }, [
      ...
      el("div", { class: "titolo-wrap" }, [
        el("span", { class: "spark s1", html: SCINTILLA }),
        el("span", { class: "spark s2", html: SCINTILLA }),
        el("span", { class: "spark s3", html: SCINTILLA }),
        el("span", { class: "spark s4", html: SCINTILLA }),
