...
(function () {
  ...
  function corsa(t, nRivali, diff) {
    ...
    var fase = "via", conto = 3, raf = null, toC = null, ultimo = 0, primoArr = 0, finito = false, arrivi = [];
    ...
    function frame(ts) {
      ...
      if (arrivi.length && !primoArr) primoArr = now;
  ...
  function hostHorto(t, diff) {
    ...
    var cav = null, nomi = null, ref = null, fase = "lobby", conto = 3, loop = null, toC = null, ultimo = 0, primoArr = 0, arrivi = [], ord = null, rete = null;
    ...
    function inizia() {
      fase = "via"; conto = 3; arrivi = []; primoArr = 0; ord = null;
