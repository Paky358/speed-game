...
(function () {
  ...
  function simbolo(s) {
    ...
    else g = '<path d="M3.75 8.7Q3.3 4 5 1.25Q6.7 4 6.25 8.7Q5 9.2 3.75 8.7Z" fill="url(#scgB)" stroke="#5a3d20" stroke-width=".35"/><path d="M4 6Q5 6.45 6 6" stroke="#4a3016" stroke-width=".3" fill="none"/><path d="M4.15 4.2Q5 4.6 5.85 4.2" stroke="#4a3016" stroke-width=".3" fill="none"/>';
  ...
  function cartaSVG(carta, w) {
    ...
    if (v >= 8) {
      centro = '<rect x="23" y="34" width="54" height="82" rx="7" fill="rgba(0,0,0,.03)" stroke="' + col + '" stroke-width="1.4" opacity=".7"/>' +
        '<text x="50" y="88" font-size="46" text-anchor="middle">' + FIG[v] + '</text>' + uso(s, 50, 107, 15);
  ...
  function renderScopa(t, C, cb) {
    ...
    var msg = vm.flash ? vm.flash : (mioTurno ? "Tocca a te" : "Tocca a " + vm.nomi.opp);
    box.appendChild(el("div", { class: vm.flash === "SCOPA!" ? "sc-flash" : "", style: "text-align:center;font-weight:800;font-size:1.1rem;margin:8px 0;color:" + (vm.flash === "SCOPA!" ? "#ffd43b" : "inherit"), text: msg }));
