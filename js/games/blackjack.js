...
(function () {
  ...
  var CSS = [
    ...
    ".bj-piano{position:absolute;left:50%;bottom:-6px;transform-origin:50% 100%;transform:rotateX(58deg);transform-style:preserve-3d;border-radius:50% 50% 14px 14px/100% 100% 14px 14px;background:linear-gradient(#7a4724,#4a2a14);padding:13px;box-shadow:0 -6px 0 #8a562c inset}",
    ".bj-panno{position:relative;width:100%;height:100%;border-radius:50% 50% 8px 8px/100% 100% 8px 8px;background:radial-gradient(80% 90% at 50% 100%,#1f8a52,#127043 60%,#0b5431);box-shadow:inset 0 0 26px rgba(0,0,0,.45);transform-style:preserve-3d}",
  ...
  function tavoloBJ(t, drv) {
    ...
    function disegnaScena() {
      ...
      var segni = vm.giocatori.map(function (g, idx) {
        ...
        var bordo = pt(1.12), pf = pt(0.8), pc = pt(0.58);
